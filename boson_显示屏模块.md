# 显示屏模块
## 实物图片
![](boson_显示屏模块_实物图.jpg "Optional title")
...
![](boson_显示屏模块_实例.png "Optional title")

## 使用说明
显示屏模块共预设了八种不同模块的信息显示（见下表），可以通过按钮切换到相应的模块编号查看。

![](boson_显示屏模块_使用说明1.png "Optional title")

按照下图所示连接电路，通电后即可通过显示屏模块上的按钮切换到空气湿度传感器模块查看空气湿度。

![](boson_显示屏模块_使用说明2.png "Optional title")
...
![](boson_显示屏模块_心率监测连线图.png "Optional title")
...
![](boson_显示屏模块_光强对植物影响连线图.png "Optional title")
...
![](boson_显示屏模块_检测物体的导电性连线图.png "Optional title")
...
![](boson_显示屏模块_土壤对种子发芽率的影响连线图.png "Optional title")
...
![](boson_显示屏模块_饮品大调查连线图.png "Optional title")

## 规格参数
引脚说明：
![](boson_显示屏模块_引脚说明.png "Optional title")
